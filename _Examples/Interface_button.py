...
class Interface_button(PGE_Button):
    def __init__(self, id, count_from_x, screen_x, count_from_y, screen_y, tag=''):
    ...
    def get_selected_block_tag(self):
        return self.selected_block_tag

    def set_selected_block(self, tag):
        self.selected_block_tag = tag
